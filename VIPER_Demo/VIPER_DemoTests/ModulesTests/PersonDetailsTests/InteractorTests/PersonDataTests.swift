    ...
    override func spec() {
        describe("person data") {
            it("should be equal when a person has the same name, age, and phone") {
                ...
                let personData = PersonData(person: person)
                let personData2 = PersonData(person: person)
            ...
            it("should be equal when a person has a different id, but same name, age, and phone") {
                ...
                let personData = PersonData(person: person1)
                let personData2 = PersonData(person: person2)
