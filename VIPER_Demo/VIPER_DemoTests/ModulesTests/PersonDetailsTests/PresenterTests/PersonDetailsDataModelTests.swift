...
class PersonDetailsDataModelTests : QuickSpec {
    override func spec() {
        describe("person data model") {
            ...
            beforeEach {
                let person = PersonDetailsData(person: Person(id: 1, name: "someName", phone: "somePhone", age: "someAge"))
            ...
            it("should be equal to another data model if it's the same person") {
                let samePerson = PersonDetailsData(person: Person(id: 2, name: "sameName", phone: "samePhone", age: "sameAge"))
            ...
            it("should not be equal to another data model if it's not the same person") {
                let aPerson = PersonDetailsData(person: Person(id: 2, name: "sameName", phone: "samePhone", age: "sameAge"))
                let aDifferentPerson = PersonDetailsData(person: Person(id: 1, name: "difName", phone: "difPhone", age: "difAge"))
